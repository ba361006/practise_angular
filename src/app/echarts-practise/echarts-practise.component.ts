      ...
      chart.setOption({
        graphic: {
          elements: [
            ...
            zoneA.element,
            zoneB.element,
            this.echartsService.drawLine(lb.top, VM1.bottom),
            this.echartsService.drawLine(lb.top, VM12.bottom),
            this.echartsService.drawLine(lb.top, VM123.bottom),
            this.echartsService.drawLine(lb.top, VM1230.bottom),
            this.echartsService.drawLine(lb.top, VM110.bottom),
            this.echartsService.drawLine(lb.top, VM10.bottom),
            this.echartsService.drawLine(lb.top, VM9.bottom),
            this.echartsService.drawLine(lb.top, VM0.bottom),
